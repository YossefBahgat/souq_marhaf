...
class SafetyCenterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: ColorsManager.backDrawer),
      body: ListView(
        ...
        children: [
          ...
          Text(
            "نعمل في منصة حراج مع هيئة حقوق الإنسان في المملكة العربية ",
            style: TextStyles.font22black,
          ),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 30.h),
            child: Text(
              "السعودية https://www.hrc.gov.sa لمكافحة الاتجار بالبشر وحماية حقوق العمالة الوافدة وتوفير الموارد اللازمة التقنية والوقائية والتوعوية ومساعدة ضحايا الاتجار بالبشر ولا نقبل استغلال المنصة لأي أغراض تتعارض مع أنظمة حقوق الإنسان المحلية والعالمية. حيث يحظر النظام في المملكة العربية السعودية – بناءً على المعايير الدولية والإقليمية لمكافحة جرائم الاتجار بالأشخاص- جميع أشكال المتاجرة بالأشخاص الموصوفة في بروتوكول منع ومعاقبة الاتجار بالبشر، وبخاصة النساء والأطفال المكمل لاتفاقية الأمم المتحدة لمكافحة الجريمة المنظمة عبر الوطنية (بروتوكول باليرم). وعندما نرصد محتوى ينتهك أنظمة حقوق الإنسان فإننا لا نتهاون في إحالة المحتوى إلى هيئة حقوق الإنسان وإيقاف عضوية المستخدم المخالف.",
              style: TextStyles.font22black,
            ),
          ),
        ],
